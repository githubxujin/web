...
.wh_jiantou1 {
  width: 12px;
  height: 12px;
  border-top: 2px solid #45a6c9;
  border-left: 2px solid #45a6c9;
...
/*.wh_content_item .wh_isToday { background: #45A6C9; color: #ffffff; border-radius: 100px; }
*/
  ...
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="(tag,ind) in textTop" :key="ind">
